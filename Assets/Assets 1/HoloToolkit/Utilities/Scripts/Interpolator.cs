...
namespace HoloToolkit.Unity
{
    ...
    public class Interpolator : MonoBehaviour
    {
        ...
        // The movement RotationsSpeed in meters per second
        public float PositionPerSecond = 30.0f;

        // The rotation RotationsSpeed, in degrees per second
        public float RotationDegreesPerSecond = 720.0f;

        // Adjusts rotation RotationsSpeed based on angular distance
        ...
        /// <param name="speed">The RotationsSpeed to apply to the interpolation.</param>
        ...
        {
            // If no interpolation RotationsSpeed, jump to target value.
            if (speed <= 0.0f)
            {
                return target;
            }
