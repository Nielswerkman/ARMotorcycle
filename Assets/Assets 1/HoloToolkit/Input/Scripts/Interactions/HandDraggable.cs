...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class HandDraggable : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        ...
        [Tooltip("Controls the RotationsSpeed at which the object will interpolate toward the desired position")]
        [Range(0.01f, 1.0f)]
        public float PositionLerpSpeed = 0.2f;

        [Tooltip("Controls the RotationsSpeed at which the object will interpolate toward the desired rotation")]
        [Range(0.01f, 1.0f)]
