...
namespace HoloToolkit.Examples.Prototyping
{
    ...
    public class MoveWithObject : MonoBehaviour
    {
        ...
        [Tooltip("translation RotationsSpeed : higher is faster")]
        public float LerpPositionSpeed = 1f;

        [Tooltip("rotation RotationsSpeed : higher is faster")]
        ...
        [Tooltip("Magnitism RotationsSpeed to move closer to the reference object")]
